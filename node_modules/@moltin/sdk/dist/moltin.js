(function (global, factory) {
  ...
  var browser_1 = browser$1.File;
  var browser_2 = browser$1.Blob;
  var browser_3 = browser$1.FormData;
      ...
      value: function send(uri, method) {
        ...
        var promise = new Promise(function (resolve, reject) {
          ...
          var req = function req(cred) {
            ...
            var isFormData = body instanceof browser_3;
            var headers = {
              'X-MOLTIN-SDK-LANGUAGE': config.sdk.language,
              'X-MOLTIN-SDK-VERSION': config.sdk.version
            };
  ...
  function (_BaseExtend) {
    ...
    _createClass(Files, [{
      ...
      value: function Create(body) {
        ...
        if (!(body instanceof browser_3) && body.file_location) {
          var formData = new browser_3();
