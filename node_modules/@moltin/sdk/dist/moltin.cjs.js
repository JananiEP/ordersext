    ...
    value: function send(uri, method) {
      ...
      var promise = new Promise(function (resolve, reject) {
        ...
        var req = function req(cred) {
          ...
          var isFormData = body instanceof formdataNode.FormData;
          var headers = {
            'X-MOLTIN-SDK-LANGUAGE': config.sdk.language,
            'X-MOLTIN-SDK-VERSION': config.sdk.version
          };
          ...
          config.auth.fetch.bind()("".concat(config.protocol, "://").concat(config.host, "/").concat(version || config.version ? "".concat(version || config.version, "/") : '').concat(uri), {
...
function () {
  ...
  _createClass(PCMVariationsRelationshipsEndpoint, [{
    ...
    key: "Create",
    value: function Create(productId, resources) {
      var body = buildRelationshipData('product-variation', resources, inflected.dasherize);
      return this.request.send("products/".concat(productId, "/").concat(this.endpoint), 'POST', body);
    }
  }, {
    key: "Delete",
...
function (_BaseExtend) {
  ...
  _createClass(Files, [{
    ...
    value: function Create(body) {
      ...
      if (!(body instanceof formdataNode.FormData) && body.file_location) {
        var formData = new formdataNode.FormData();
        formData.append('file_location', body.file_location);
        requestBody = formData;
      }

      return this.request.send("".concat(this.endpoint), 'POST', requestBody, undefined, undefined, false);
    }
  }, {
    key: "Delete",
    value: function Delete(id) {
...
function (_CatalogQuery2) {
  _inherits(Hierarchies, _CatalogQuery2);
  ...
  _createClass(Hierarchies, [{
    ...
    value: function GetHierarchyChildren(_ref6) {
      var hierarchyId = _ref6.hierarchyId,
          _ref6$token = _ref6.token,
          token = _ref6$token === void 0 ? null : _ref6$token;
...
function (_CatalogQuery3) {
  _inherits(Products, _CatalogQuery3);
  ...
  _createClass(Products, [{
    ...
    value: function Get(_ref9) {
      var productId = _ref9.productId,
          _ref9$token = _ref9.token,
          token = _ref9$token === void 0 ? null : _ref9$token;
      return this.request.send("catalog/".concat(this.endpoint, "/").concat(productId), 'GET', undefined, token);
    }
  }, {
    key: "GetProductsByNode",
    value: function GetProductsByNode(_ref10) {
    ...
    value: function GetProductsByHierarchy(_ref11) {
      var hierarchyId = _ref11.hierarchyId,
          _ref11$token = _ref11.token,
          token = _ref11$token === void 0 ? null : _ref11$token;
      var limit = this.limit,
          offset = this.offset,
